...
class LoginTests(unittest.TestCase):
    ...
    def setUp(self):
        app = ('/Users/jaimini.chaturvedi/Library/Developer/Xcode/DerivedData/AppiumTest-feoybtvfaibiryfkubcyymwwoxrz/Build/Products/Debug-iphonesimulator/AppiumTest.app')
